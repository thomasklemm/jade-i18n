...
module.exports.__ = function(language, str, obj, desc){
  ...
  if (lookup == undefined && (!(language in notifications) || !(str in notifications[language]))){
    notifications[language] = notifications[language] || {};
    notifications[language][str] = 1;
    i18n.emit('missing', language, str, desc);
